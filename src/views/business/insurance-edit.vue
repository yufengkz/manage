    ...
    <div class="add" v-loading='loading'>
      ...
      <div>
        ...
        <div class="inputs desc">
          ...
          <el-upload class="avatar-uploader111" action="http://up.qiniu.com" :data='token' :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
            <img v-if="logoUrl" :src="logoUrl" class="avatar">
            <i v-else class="el-icon-plus avatar-uploader111-icon"></i>
          </el-upload>
        ...
        <div class="inputs desc">
          ...
          <el-upload class="avatar-uploader111" action="http://up.qiniu.com" :data='token' :show-file-list="false" :on-success="handleAvatarSuccess2" :before-upload="beforeAvatarUpload2">
        ...
        <div class="inputs desc">
          <label>*详情页描述：</label>
          <el-upload class="avatar-uploader111" action="http://up.qiniu.com" :data='token' :show-file-list="false" :on-success="handleAvatarSuccess3" :before-upload="beforeAvatarUpload3">
...
export default {
  data() {
    return {
      ...
      token: { token: null },
      urls: {
        getInsurance: "insurances/getInsurance",
        modify: "insurances/modify",
      }
    };
  },
  methods: {
