    ...
    <div class="tabs">
      ...
      <div class="media-manage-table material">
        <div class="search">
          ...
          <el-button class='addArticle' type='primary' size='mini' @click="$router.push('/insuranceadd')">添加项目</el-button>
        </div>
        <!-- 列表 -->
        <el-table class="credit" ref="multipleTable" v-loading='tableLoading1' :data="tableData1" key="table1" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" @click="$router.push('/insuranceedit?id='+scope.row.id)">编辑</el-button>
